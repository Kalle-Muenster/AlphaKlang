...
SkyBox::InitializeObject(string imagefilename,bool addToScene)
{
	...
	walls[front]->conXtor->ConIDs[0] = walls[front]->conXtor->ConnectConnectableInstance(this->conXtor);
...
//	walls[front]->AddConnectable<MusicVox>();
	...
	walls[rear]->conXtor->ConIDs[0] = walls[rear]->conXtor->ConnectConnectableInstance(this->conXtor);
...
//	walls[rear]->AddConnectable<MusicVox>();
	...
	walls[left]->conXtor->ConIDs[0] = walls[left]->conXtor->ConnectConnectableInstance(this->conXtor);
...
//	walls[left]->AddConnectable<MusicVox>();
	...
	walls[right]->conXtor->ConIDs[0] = walls[right]->conXtor->ConnectConnectableInstance(this->conXtor);
...
//	walls[right]->AddConnectable<MusicVox>();
	...
	walls[top]->conXtor->ConIDs[0] = walls[top]->conXtor->ConnectConnectableInstance(this->conXtor);
...
//	walls[top]->AddConnectable<MusicVox>();
	...
	walls[bottom]->conXtor->ConIDs[0] = walls[bottom]->conXtor->ConnectConnectableInstance(this->conXtor);
...
SkyBoxConnector::Initialize(void)
{
	...
	thisTypeHashCode=typeid(SkyBoxConnector).hash_code();
