...
MusicControllerPanel::MusicControllerPanel(void)
{
	...
	GetConnected<Knob>(2)->Value.MOVE = 0.1;
	...
	GetConnected<Knob>(3)->Value.MOVE = 0.1;
	...
	GetConnected<Knob>(4)->Value.SetUp(0,126,1,1,Controlled<float>::Clamp);
	...
	GetConnected<Knob>(5)->Value.SetUp(1,127,64,1,Controlled<float>::Clamp);
	...
	GetConnected<ButtonControl>(8)->PositionOnPanel = VectorF(10,450);	
	GetConnected<ButtonControl>(8)->SizeScaledPanel = VectorF(0.9,0.2);
